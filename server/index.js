...
app.post("/add",(req,res)=>{
  //const {registerno, course, year,subjectcode, avgtheory, avgassignment, attendance, seminar, internal_marks} = req.body
  console.log(req.body); 
  var sqlinsert = "INSERT INTO marks(registerno,course, year,subjectcode, avgtheory, avgassignment, attendance, seminar, internal_marks) VALUES (?,?,?,?,?,?,?,?,?)"
  mysqlconnection.query(sqlinsert,[registerno,course,year,subjectcode,avgtheory,avgassignment,attendance,seminar,internal_marks],(err,result)=>{
...
app.get('/export1', function(request, response, next){
  ...
  mysqlconnection.query('SELECT * FROM marks WHERE (course)', function(error, data){
...
app.post("/test",(req,res)=>{
  console.log(req.body);
  mysqlconnection.query(`SELECT * from marks WHERE (course = '${req.body.course1}' AND year = '${req.body.year1}');`,(err,data)=>{
    console.log(data);
